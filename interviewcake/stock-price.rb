...
def get_max_profit(stock_prices_yesterday)
  ...
  (0...stock_prices_yesterday.length).each do |outer_time|
    ...
    (0...stock_prices_yesterday.length).each do |inner_time|
      ...
      #puts "earlier_time = [#{outer_time}, #{inner_time}] = #{earlier_time}"
...
stock_prices_yesterday = [10, 7, 128, 5, 67]
ap stock_prices_yesterday
ap get_max_profit(stock_prices_yesterday)
